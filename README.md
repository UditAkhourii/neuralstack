...
This will:
1. Ask for your **free NeuralStack API key** (get one at https://thinklm.vercel.app → Settings → API key).
...
`NEURALSTACK_API_URL` defaults to `https://thinklm.vercel.app`; set it to
